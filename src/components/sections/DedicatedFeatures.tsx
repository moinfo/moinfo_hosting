...
import { dedicatedFeatureSections, dedicatedPlanNames } from "@/data/dedicated-features";
...
export function DedicatedFeatures() {
  return (
    <section className={classes.section}>
      <Container size="xl">
        <Accordion variant="separated" radius="md" defaultValue="Dedicated Plan Features">
          {dedicatedFeatureSections.map((section) => (
