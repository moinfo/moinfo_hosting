export const company = {
  ...
  social: {
    ...
    linkedin: "https://linkedin.com/company/moinfotech",
    twitter: "https://twitter.com/moinfotech",
  },
  tawkTo: {
    propertyId: "64f07ba4b2d3e13950ed240a",
    widgetId: "1h95m5vle",
  },
};
...
export const footerLinks = {
  ...
  hosting: [
    { labelKey: "footer.webHosting", href: "/web-hosting" },
    { labelKey: "footer.emailHosting", href: "/email-hosting" },
    { labelKey: "footer.vpsHosting", href: "/vps" },
    { labelKey: "footer.dedicatedServer", href: "/dedicated-server" },
    { labelKey: "footer.resellerHosting", href: "/linux-reseller" },
  ...
  resources: [
    ...
    { labelKey: "footer.hostingPolicy", href: "/hosting-policy" },
    { labelKey: "footer.acceptableUse", href: "/acceptable-use" },
